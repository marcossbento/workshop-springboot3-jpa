package com.marcossbento.webServicesProject.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> database(DatabaseExcepiton e, HttpServletRequest request) {
